<head>
  <meta name="google-site-verification" content="imtz-eJdm3S24d1hoRZqZy5hLlnB7FaYxUPQAgOkjMg" />
</head>
...
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0D5F1A&height=200&section=header&text=I%20am%20Shubham,&fontSize=80&fontColor=FFFFFF&animation=fadeIn&fontAlignY=38" width="100%"/>
</div>
...
```bash
$ whoami
> shubham@shipt:~$ Cybersecurity enthusiast and Web Developer passionate about  coding and  hacking

$ ./skills.sh --list-top
> [Loading complete]: C/C++ | Python | JavaScript | social engineering | web-Devlopment | Linux
...
$ cat /etc/addresh | grep contact
> Noida | @ :  shubscript213@gmail.com
```
</div>
...
int main() {
    std::cout << "\033[1;31m  ____   \033[1;34m__  __ \n";
    std::cout << "\033[1;31m / __ \\  \033[1;34m|  \\/  |\n";
    std::cout << "\033[1;31m| |  | | \033[1;34m| \\  / |\n";
    std::cout << "\033[1;31m| |  | | \033[1;34m| |\\/| |\n";
    std::cout << "\033[1;31m| |__| | \033[1;34m| |  | |\n";
    std::cout << "\033[1;31m \\____/  \033[1;34m|_|  |_|\n";
...
<div align="center">
  ...
  <a href="mailto:your-email@gmail.com" target="_blank">
    <img src="https://img.shields.io/badge/shubscript213@gmail.com-0D5F1A?style=for-the-badge&logo=gmail&logoColor=white" alt="Contact">
  </a>
</div>
...
<!-- Animated Footer -->
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0D5F1A&height=150§ion=footer&text=%20%20%20&fontSize=24&fontColor=FFFFFF&animation=fadeIn&fontAlignY=65" width="100%"/>
</div>
